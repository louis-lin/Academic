function [ fig, undefPlot, defPlot ] = Plot_ANY_Deflected_Shape(U_glob, scale, ID, XY, lsPlot, undefColor, undefLineWidth, defColor, defLineWidth, figNum)
...
for i = 1:n_ele
    undefPlot = ...
        ...
        'LineWidth', undefLineWidth, 'Color', undefColor);
end
% Deformed Shape
for ls = 1:nlsPlot
    figure(figNum)
    ...
    for i = 1:n_ele
        plot([XY(i,1)+U_ele(1,ls,i) XY(i,3)+U_ele(4,ls,i)],...
            ...
            'ks','LineWidth',1,'MarkerFaceColor',[0.5 0.5 0.5]);
        defPlot = ...
            plot([XY(i,1)+U_ele(1,ls,i) XY(i,3)+U_ele(4,ls,i)],...
            [XY(i,2)+U_ele(2,ls,i) XY(i,4)+U_ele(5,ls,i)],...
            'LineStyle', '-', 'LineWidth', defLineWidth, 'Color', defColor);
    end
end
axis equal
end