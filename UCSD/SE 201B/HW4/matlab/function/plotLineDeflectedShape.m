function [ fig, undefPlot, defPlot ] = plotLineDeflectedShape(modelDefFilePath, deflectedShapeDirPath, nDim, loadStep, defScale, crdTransfMatrix, undefColor, undefLineWidth, defColor, defLineWidth, figNum)
%% DESCRIPTION
...
[modelDefFilePath, deflectedShapeDirPath] = convertStringsToChars(modelDefFilePath, deflectedShapeDirPath);

if ~ismember(nDim,[2,3])
    error('Incorrect dimension! Should be 2 or 3.')
end

modelDataFile_fid = fopen(modelDefFilePath,'r');
