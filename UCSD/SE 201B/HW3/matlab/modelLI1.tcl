...
set fpc             [expr -32.2*$MPa]
set Ec              [expr 27100.0*$MPa]
set epsc0           [expr 2.0*$fpc/$Ec]
set ft              [expr 4.8*$MPa]
set lambda          0.25
set Ets             [expr 0.01*$Ec]
set fpcU            [expr 0.2*$fpc]
set epsU            -0.004

# Define confined concrete material parameters
set fpcc            [expr -53.7*$MPa]
set Ecc             [expr 27100.0*$MPa]
set epscc0          [expr 2.0*$fpcc/$Ecc]
set ftc             [expr 4.8*$MPa]
set lambdac         0.25
set Etsc            [expr 0.01*$Ecc]
set fpccU           [expr 0.85*$fpcc]
set epscU           -0.0276

# Define steel material parameters
set fy              [expr 450.0*$MPa]
set Es              [expr 218300.0*$MPa]
set b               0.0219
set R0              20.0
set cR1             0.925
set cR2             0.15
