...
for axial_Load = [0.0, 0.1, 0.2, 0.4, 0.6, 0.7]
    ...
    plot(MK(:,3),MK(:,1),'LineWidth',1.5); hold on;
    grid on; box on; title("Moment Curvature For Axial Load Ratio "+ sprintf('%1.1f',axial_Load))
    ...
    print_figure("Part G i Cyclic MK"+ num2str(axial_Load*10,'%i'),[13,5],18)
    close(3)
    ...
    print_figure("Part G ii Axial Strain Axial Load Ratio "+ num2str(axial_Load*10,'%i') ,[3.25,3.25])
    close(4)
end
