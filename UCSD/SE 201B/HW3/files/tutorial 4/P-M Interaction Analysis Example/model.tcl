...
section Fiber $secTag -GJ $Ubig {
    ...
    # Cover concrete
    patch rect $matTagConcCover 7   1   [expr $cover - $y1]     [expr -$z1]             [expr $y1 - $cover]      [expr $cover - $z1]
    patch rect $matTagConcCover 7   1   [expr $cover - $y1]     [expr $z1 - $cover]     [expr $y1 - $cover]      [expr $z1]
    patch rect $matTagConcCover 2   1   [expr -$y1]             [expr -$z1]             [expr $cover - $y1]      [expr $z1]
    patch rect $matTagConcCover 2   1   [expr $y1 - $cover]     [expr -$z1]             [expr $y1]               [expr $z1]
    
    # Core concrete
    patch rect $matTagConcCore  7   1   [expr $cover - $y1]     [expr $cover - $z1]     [expr $y1 - $cover]     [expr $z1 - $cover]
