function [y, Ac, Acc] = areas_circle(Section)
% Obtains fiber discretization geometry for circular section
%% Input
% A section structure with the following:
...
% fiber (vector)
% Ac is the area of unconfined concrete of eachbar fiber (vector)
% Acc is the area of confined concrete of each fiber (vector)
%%

D = Section.diameter;
ds = Section.diameter_confined;
t = Section.fiber_width;
n = Section.no_of_fibers;
